...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> itemscope itemprop="ImageGallery" itemtype="http://schema.org/ImageGallery">
	<?php tha_entry_top(); ?>
	...
	<?php if ( 'post' == get_post_type() ) : ?>
		<div class="entry-meta">
			<span class="genericon genericon-time"></span> <?php aj_posted_on(); ?>
		</div><!-- .entry-meta -->
	<?php
endif; ?>
	</header><!-- .entry-header -->
	...
	if ( $categories_list && aj_categorized_blog() ) :
	?>
