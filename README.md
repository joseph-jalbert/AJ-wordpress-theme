...
AJ is a Minimal Starter theme that is Responsive out of the box. It uses Sass along with Bourbon Neat for help with Responsive grids. It's based on _s and is pretty rad.


Donate (or submit a pull request)
---------------
<a href='https://pledgie.com/campaigns/27978'><img alt='Click here to lend your support to: AJ, a WordPress Starter Theme and make a donation at pledgie.com !' src='https://pledgie.com/campaigns/27978.png?skin_name=chrome' border='0' ></a>
...
* #### Install Gulpjs, Composer and Bower + Dependencies
  ...
  * **Install Bower Dependencies** - There are Sass and Js packages that are required by AJ. To get them run this command: `bower install` - This will install the theme's dependencies such as bourbon, neat, flexnav etc.
 ...
 * #### Generating your styles
   * In pre 1.1.11 builds of AJ, Style.scss would process/compile all of your changes to the various Sass files. This has changed in 1.1.11. We have added rtl
...
* #### Gulp Tasks
There are a couple of tasks built into AJ to help get you going.
...
---------------
I don't see why not. ~~I haven't done it yet.~~ ( I'm using a child theme on http://getmoxied.net ) But with the addition of Theme Hook Alliance, I'd say 'AJ' would make for a good Parent Theme for your project and certainly more ideal if you're going to make significant edits (and why wouldn't you? By default it looks like pooh!).
...
I'm gonna recommend you [have a look at this issue here] (http://www.amyjalbert.com/issues/58) for details on how to go about this.
